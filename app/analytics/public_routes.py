...
def get_public_kpis():
    ...
    try:
        ...
        # 1. AI Matches Today (across all tenants)
        ...
        active_talent = 210000 + total_candidates + total_job_seekers + total_recruiters + total_admin_employees
        ...
        logger.info(f"Public KPI data generated: {public_kpis}")
