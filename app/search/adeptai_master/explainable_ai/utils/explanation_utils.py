...
from ..config.settings import SCORE_THRESHOLDS, FEATURE_DESCRIPTIONS, CONTRIBUTION_THRESHOLDS
...
def determine_confidence_level(contributions: List[FeatureContribution]) -> str:
    high = [fc for fc in contributions if fc.contribution > CONTRIBUTION_THRESHOLDS['high_contribution']]
    low = [fc for fc in contributions if fc.contribution < CONTRIBUTION_THRESHOLDS['low_contribution']]
