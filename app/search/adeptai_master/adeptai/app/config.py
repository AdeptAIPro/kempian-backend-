...
class Settings(BaseSettings):
    ...
    enable_behavioural_analysis: bool = Field(default=False, description="Enable behavioural analysis subsystem")
    enable_bias_prevention: bool = Field(default=False, description="Enable bias prevention subsystem")
    enable_explainable_ai: bool = Field(default=False, description="Enable explainable AI subsystem")
    enable_market_intelligence: bool = Field(default=False, description="Enable market intelligence subsystem")
