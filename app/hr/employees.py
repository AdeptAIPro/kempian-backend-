...
def create_employee():
    ...
    # Debug logging
    print(f"[DEBUG] Creating employee with data: email={email}, organization_id={organization_id}, employment_type={employment_type}, category={category}")
    ...
    if not employment_type:
        return jsonify({'error': 'Employment type is required'}), 400
    if not category:
