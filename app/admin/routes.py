...
from app.auth.cognito import cognito_admin_create_user, cognito_admin_update_user_attributes
import logging
...
AUTHORIZED_ADMIN_EMAILS = ['vinit@adeptaipro.com', 'rushikesh@adeptaipro.com', 'contact@kempian.ai']
