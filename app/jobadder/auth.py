...
class JobAdderAuth:
    ...
    def __init__(self, client_id, client_secret, scope=None):
        ...
        self.authorize_url = os.getenv("JOBADDER_AUTHORIZE_URL", "https://id.jobadder.com/oauth2/authorize")
        self.token_url = os.getenv("JOBADDER_TOKEN_URL", "https://id.jobadder.com/connect/token")
        self.api_base_url = os.getenv("JOBADDER_API_BASE_URL", "https://api.jobadder.com/v2")
        self.access_token = None
        self.refresh_token = None
        self.token_expires_at = None
        self.scope = scope or os.getenv("JOBADDER_DEFAULT_SCOPE", "jobadder.api offline_access")
